...
import { getResultCopy } from "../../src/content/resultCopy";
        ...
        <div className="grid gap-5">
          ...
          <ResultCard>
            ...
            <p className="mt-3 text-[14px] font-semibold leading-6 text-[rgba(97,74,55,0.72)]">
              {resultCopy.moneyPattern}
            </p>
            <div className="mt-5 grid gap-3">
              <InsightRow
                icon="근"
                title="사주에서 보이는 장면"
                body={resultCopy.elementReason}
              />
              <InsightRow
                icon="↗"
                title="돈이 들어오는 방식"
                body={resultCopy.moneyPattern}
              />
              <InsightRow
                icon="장"
                title="반복되기 쉬운 장면"
                body={resultCopy.riskPoint}
              />
              <InsightRow
                icon="↓"
                title="돈이 막히거나 새는 지점"
