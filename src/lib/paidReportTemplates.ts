...
export const paidReportTemplateMap: Record<TemplateId, PaidReport> = {
  ...
  8: {
    ...
    actionPlan: {
      ...
      thirtyDays: ["경험 기반 콘텐츠를 주 2회 발행합니다.", "하나의 방향을 30일간 고정합니다.", "시행착오를 체크리스트나 자료로 바꿉니다."],
    },
  ...
  9: {
    ...
    actionPlan: {
      ...
      thirtyDays: ["질문 10개를 묶어 미니 자료로 만듭니다.", "상담이나 강의 형태의 작은 상품을 만듭니다.", "실전 사례를 포트폴리오로 정리합니다."],
    },
    ...
    previewSections: [
      ...
      { title: "30일 콘텐츠 플랜", teaser: "질문을 모아 유료 자료로 바꾸는 순서를 제안합니다." },
    ],
  },
  10: {
    id: 10,
