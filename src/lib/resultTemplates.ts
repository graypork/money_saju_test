...
export const resultTemplateMap: Record<TemplateId, ResultTemplate> = {
  1: {
    ...
    summary:
      "당신은 단기 승부보다 실력, 신뢰, 반복 경험이 쌓인 뒤 돈의 흐름이 커지는 사람에 가깝습니다. 초반 반응이 약해도 구조가 잡히면 쉽게 무너지지 않는 쪽입니다.",
    coreMessage:
  ...
  2: {
    ...
    summary:
      "당신은 정해진 틀 안에서 버티기보다 감각과 아이디어를 결과물로 바꿀 때 돈의 가능성이 커집니다. 다만 흥미가 식으면 수익화 직전에 멈출 수 있습니다.",
    coreMessage:
  ...
  3: {
    ...
    summary:
      "당신은 무리한 선택보다 안정적인 구조 안에서 돈을 모으고 키우는 쪽에 강합니다. 다만 안전만 고집하면 수익 확장의 타이밍을 놓칠 수 있습니다.",
    coreMessage:
  ...
  4: {
    ...
    hook: "당신은 기다릴수록 약해지고, 검증할수록 강해지는 쪽입니다.",
    oneLineDiagnosis: "기회 감각은 있는데, 검증 없이 밀면 수익과 손실이 같이 커집니다.",
    summary:
      "당신은 가만히 기다리는 것보다 직접 움직일 때 돈의 가능성이 커집니다. 흐름을 빨리 보고 반응하는 힘이 있지만, 속도가 빠른 만큼 기준이 필요합니다.",
    coreMessage:
  ...
  5: {
    ...
    summary:
      "당신은 혼자 고립돼서 돈을 버는 구조보다 사람과 연결될 때 기회가 커지는 타입입니다. 다만 모두에게 좋은 사람으로 남으려 하면 정작 내 수익 구조가 약해질 수 있습니다.",
    coreMessage:
  ...
  10: {
    ...
    hook: "당신은 팔 수 있는 사람인데, 부탁처럼 말하면 돈 받을 기회를 놓칩니다.",
  ...
  11: {
    ...
    coreMessage:
      "당신은 돈의 흐름을 읽는 감각이 있습니다. 하지만 너무 오래 재면 기회는 지나갑니다. 분석은 강점이지만 실행을 미루는 핑계가 되면 약점입니다.",
